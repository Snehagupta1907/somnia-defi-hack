...
contract UniswapV3Pool is IUniswapV3Pool {
        ...
        )
    {
        ...
        if (slot0_.tick < params.lowerTick) {
            amount0 =LibMath.calcAmount0Delta(
            ...
            amount1 =LibMath.calcAmount1Delta(
                TickMath.getSqrtRatioAtTick(params.lowerTick),
                slot0_.sqrtPriceX96,
                params.liquidityDelta
            );
    ...
    function flash(
        ...
        uint256 fee0 =LibMath.mulDivRoundingUp(amount0, fee, 1e6);
        uint256 fee1 =LibMath.mulDivRoundingUp(amount1, fee, 1e6);
